...
public class ChatRoomService {
    ...
    private void initUsersAndMessages(ChatRoom chatRoom) {
        System.out.println("initUsersAndMessages:" + chatRoom.getName());
        List<String> userIds = chatRoomMapper.getUsersByChatRoomId(chatRoom.getId());
        for (String userId : userIds) {
            User user = userService.getUserById(userId);
            chatRoom.addUser(user);
        }
        chatRoom.setMessages(messageService.getMessagesInChatRoom(chatRoom.getId()));
    }
    ...
    public ChatRoom createChatRoom(String username, String chatRoomName) {
        ...
        chatRoomMapper.addUserToChatRoom(userId, chatRoom.getId());
    ...
    public ChatRoom addUserToChatRoom(String user, String chatRoomName) {
        ...
        String chatRoomId = chatRoomMapper.getChatRoomByName(chatRoomName).getId();
        if (chatRoomId == null) {
            return null;
        }
